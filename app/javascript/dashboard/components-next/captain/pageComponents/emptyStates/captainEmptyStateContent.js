...
export const documentsList = [
  {
    ...
    id: 3059,
    name: 'How to use Conversation Filters? | User Guide | MetroIA',
    status: 'available',
  },
  {
    account_id: 2,
    ...
    content:
      'Step-by-step guide for automating ticket assignments and improving support workflow in MetroIA.',
    created_at: 1736143273,
    external_link:
      'https://www.chatwoot.com/hc/user-guide/articles/1677688200-automating-ticket-assignments',
    id: 3060,
    name: 'Automating Ticket Assignments | User Guide | MetroIA',
    status: 'available',
  },
  {
    account_id: 3,
    ...
    id: 3061,
    name: 'Managing Customer Profiles | User Guide | MetroIA',
    status: 'available',
  },
  {
    account_id: 4,
    ...
    id: 3062,
    name: 'Sales Tracking Guide | User Guide | MetroIA',
    status: 'available',
  },
  {
    account_id: 5,
    ...
    content:
      'How to efficiently create, manage, and resolve tickets in MetroIA.',
    created_at: 1736143276,
    external_link:
      'https://www.chatwoot.com/hc/user-guide/articles/1677688230-managing-tickets',
    id: 3063,
    name: 'Managing Tickets | User Guide | MetroIA',
    status: 'available',
  },
  {
    account_id: 6,
    ...
    id: 3064,
    name: 'Financial Reporting | User Guide | MetroIA',
    status: 'available',
  },
];
...
export const responsesList = [
  {
    ...
    id: 87,
    question: 'Why is my Messenger in MetroIA deactivated?',
    status: 'pending',
    assistant: {
      account_id: 1,
      config: { product_name: 'MetroIA' },
  ...
  },
  {
    ...
    id: 88,
    question: 'How do I integrate WhatsApp with MetroIA?',
    assistant: {
      account_id: 2,
      config: { product_name: 'MetroIA' },
  ...
  },
  {
    ...
    id: 89,
    question: 'How can I reset my password in MetroIA?',
    assistant: {
      account_id: 3,
      config: { product_name: 'MetroIA' },
  ...
  },
  {
    ...
    id: 90,
    question: 'How do I enable dark mode in MetroIA?',
    assistant: {
      account_id: 4,
      config: { product_name: 'MetroIA' },
  ...
  },
  {
    ...
    id: 91,
    question: 'How do I add a new team member in MetroIA?',
    assistant: {
      account_id: 5,
      config: { product_name: 'MetroIA' },
  ...
  },
  {
    account_id: 6,
    answer:
      "Campaigns in MetroIA allow you to send targeted messages to specific user segments. You can create them in the 'Campaigns' section.",
    created_at: 1736283380,
    id: 92,
    question: 'What are campaigns in MetroIA?',
    assistant: {
      account_id: 6,
      config: { product_name: 'MetroIA' },
